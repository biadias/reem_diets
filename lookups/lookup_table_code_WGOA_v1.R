...
race_lookup_base_v2 <- race_lookup_base %>%
  ...
  mutate(final_wgoa = case_when(final_wgoa =="MISC_NA"         ~ "MISC_NA",   
                           final_wgoa =="Shelf_demersals" ~ "Shelf demersal fish", 
                           final_wgoa =="ZERO"            ~ "ZERO", 
                           final_wgoa =="Sharks_demersal" ~ "Pacific sleeper shark", #FLAG ####
                           ...
                           final_wgoa =="Pacific_pomfret"       ~ "MISC_NA", #FLAG ####
                           ...
                           final_wgoa =="Chinook_salmon"  ~ "Salmon returning", #FLAG ####
                           final_wgoa =="Coho_salmon"     ~ "Salmon returning", #FLAG ####
                           final_wgoa =="Pink_salmon"     ~ "Salmon returning", #FLAG ####
                           final_wgoa =="Chum_salmon"     ~ "Salmon returning", #FLAG ####
                           final_wgoa =="Sockeye_salmon"  ~ "Salmon returning", #FLAG ####
                           final_wgoa =="Pacific_saury"   ~ "MISC_NA", #FLAG ####
  ...
  mutate(final_egoa = case_when(final_egoa =="MISC_NA"         ~ "MISC_NA",   
                                final_egoa =="Shelf_demersals" ~ "Shelf demersal fish", 
                                final_egoa =="ZERO"            ~ "ZERO", 
                                final_egoa =="Sharks_demersal" ~ "Pacific sleeper shark", #FLAG ####
                                ...
                                final_egoa =="Arrowtooth_flounder"    ~"Arrowtooth flounder adult", 
                                ...
                                final_egoa =="Rex_sole"               ~"Rex sole adult", 
                                final_egoa == "NA"                    ~ "NA", 
                                ...
                                final_egoa =="Pacific_pomfret"       ~ "MISC_NA", #FLAG ####
                                ...
                                final_egoa =="Pacific_cod"           ~"Pacific cod adult", 
                                ...
                                final_egoa =="Chinook_salmon"  ~ "Chinook (king) salmon", #FLAG ####
                                final_egoa =="Coho_salmon"     ~ "Coho (silver) salmon", #FLAG ####
                                final_egoa =="Pink_salmon"     ~ "Pink (humpback) salmon", #FLAG ####
                                final_egoa =="Chum_salmon"     ~ "Chum (dog) salmon", #FLAG ####
                                final_egoa =="Sockeye_salmon"  ~ "Sockeye (red) salmon", #FLAG ####
                                final_egoa =="Pacific_saury"   ~ "MISC_NA", #FLAG ####
